    ...
    <div className="flex sm:text-xs md:text-xs font-sans">
        <div className="rounded-lg border border-white/10 px-3 py-3  drop-shadow-lg text-black mt-15 font-serif backdrop-blur-none rounded-lg  w-200  ml-3 bg-blue-50">
            ...
            <div className="ml-4 mb-3">
                <div className="flex">
               <div className="mt-1.5 mr-2 size-3 rounded-full bg-radial-[at_50%_75%] from-sky-200 via-blue-400 to-indigo-900 to-90% sm:text-xs md:text-xs"></div> 
            <p>Secure Login</p>
            </div>
        ...
        <div className="ml-4 mb-3">
            ...
            <p className="sm:text-xs md:text-xs">Reports are reviewed, approved if required, and stored as part of a secure, searchable service history.</p>
        </div>
        </div>
        <div className="text-black font-serif rounded-lg border border-white/10 px-3 py-3  drop-shadow-lg text-black mt-15 font-serif backdrop-blur-none rounded-lg  w-200  ml-3 bg-blue-50 sm:text-xs md:text-xs">
            <h1>Key Benefits</h1>
            <p>Saves time</p>
